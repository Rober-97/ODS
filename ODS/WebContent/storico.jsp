...
<%
		for(OrdineBean ordine : listaOrdini){
			...
			Collection<ProdottoBean> prodotti = prodModel.doRetrieveByOrder(ordine.getIdOrdine());
...
%>
              		...
              		<br>Taglia: <%= ((ProdottoInOrdineBean)prodotto).getTaglia() %><br>Quantit&agrave;: <%= ((ProdottoInOrdineBean)prodotto).getQuantita() %><br>&euro; <%= formatter.format(prodotto.getPrezzoCompl()) %>
<%
			}
%>
              </li>
