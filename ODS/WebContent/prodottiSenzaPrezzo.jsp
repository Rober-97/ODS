...
<%		ProdottoModelDM model = new ProdottoModelDM();
    	Collection<ProdottoBean> prod = model.doRetrieveAllNotInVendita();
%>    
        ...
        <div class="col-md-3 col-sm-6">
 		...
 		<form action="InsPrezzoControl" method="post" name="insP">
                ...
                <div class="product-content">
                	<input type ="hidden" name=id_prodotto value=<%=bean.getIdProdotto() %> >
                    <h3 class="title"><%=bean.getMarca() + " "+  bean.getModello() %></h3>
                    <div class="price" id='prezzo'> &euro; <%=bean.getPrezzoCompl() %>
