...
%>
<hr>
<h3 class="scrittacarrello , bordo1">CARRELLO</h3>
<hr>
<div class="bottoni">
...
%>
	  ...
	  <tr>	 
	      ...
	      <td>&euro; <%= formatter.format(beancart.getPrezzoCompl()) %></td>
			<td><a href="CartControl?invia=rimuovi&id=<%=beancart.getIdProdotto()%>">Rimuovi dal carrello</a></td>
	    </tr>
	<%
		}
	%>
